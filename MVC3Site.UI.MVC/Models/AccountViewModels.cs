...
namespace MVC3Site.UI.MVC.Models
{
    ...
    public class RegisterViewModel
    {
        ...
        //if we were using this as an addition to another set of table records (such as who created/updated this record)
        //or for greeting users (Login Partial) - create the readonly property (for display purposes only)
        [Display(Name = "User")]
